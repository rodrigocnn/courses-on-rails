...
class InstructorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post instructors_url, params: { instructor: { cpf: @instructor.cpf, date_of_birth: @instructor.date_of_birth, email: @instructor.email, name: @instructor.name, phone: @instructor.phone, string: @instructor.string, subject: @instructor.subject } }
    end
  ...
  test "should update instructor" do
    patch instructor_url(@instructor), params: { instructor: { cpf: @instructor.cpf, date_of_birth: @instructor.date_of_birth, email: @instructor.email, name: @instructor.name, phone: @instructor.phone, string: @instructor.string, subject: @instructor.subject } }
